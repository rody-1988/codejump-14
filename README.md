...
| :------------- | :-------------------------- | :------------------------------ |
| **`.hero`**    | ビデオ全幅 + キャッチコピー | **全画面ビデオ固定**            |
| **`.project`** | 2列2行の画像グリッド        | **グラデーション背景**          |
| **`.feature`** | 画像・テキスト交互配置      | **グラデーション背景**          |
| **`.flow`**    | ステップ図解（1.2.3...）    | 背景：白                        |
| **`.contact`** | お問い合わせフォーム        | 背景：白                        |
| **`.footer`**  | コピーライト表示            | 背景：黒 / `l-content` 内に配置 |
